...
public class CustomVillagePiece2 implements IVillageCreationHandler    {
 
    @Override
    public PieceWeight getVillagePieceWeight(Random random, int i) {
        // TODO Auto-generated method stub
        return new PieceWeight(CustomOceanMonument.class, 151, 1);
   ...
   /* public PieceWeight[] getVillagePieceWeightArray(Random random, int i) {
    ...
    public Class<?> getComponentClass() {
        // TODO Auto-generated method stub
        return CustomOceanMonument.class;
    }
 ...
 */
    ...
    public Object buildComponent(PieceWeight villagePiece, Start startPiece,
        ...
        return new CustomOceanMonument();
    }
