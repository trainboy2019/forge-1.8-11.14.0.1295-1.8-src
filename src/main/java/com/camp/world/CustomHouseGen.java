...
public class CustomHouseGen implements IVillageCreationHandler    {
 
    @Override
    public PieceWeight getVillagePieceWeight(Random random, int i) {
        // TODO Auto-generated method stub
        return new PieceWeight(CustomHouse.class, 150, 3);
 ...
 */
    ...
    public Object buildComponent(PieceWeight villagePiece, Start startPiece,
        ...
        return new CustomHouse(startPiece, p5, random, structureboundingbox, facing);
    }
