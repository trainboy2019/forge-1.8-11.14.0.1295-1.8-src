...
public class CustomOceanMonumentPieces
{
    private static final String __OBFID = "CL_00001994";

    public static void func_175970_a()
    {
        MapGenStructureIO.registerStructureComponent(CustomOceanMonumentPieces.MonumentBuilding.class, "OMB");
        MapGenStructureIO.registerStructureComponent(CustomOceanMonumentPieces.MonumentCoreRoom.class, "OMCR");
        MapGenStructureIO.registerStructureComponent(CustomOceanMonumentPieces.DoubleXRoom.class, "OMDXR");
        MapGenStructureIO.registerStructureComponent(CustomOceanMonumentPieces.DoubleXYRoom.class, "OMDXYR");
        MapGenStructureIO.registerStructureComponent(CustomOceanMonumentPieces.DoubleYRoom.class, "OMDYR");
        MapGenStructureIO.registerStructureComponent(CustomOceanMonumentPieces.DoubleYZRoom.class, "OMDYZR");
        MapGenStructureIO.registerStructureComponent(CustomOceanMonumentPieces.DoubleZRoom.class, "OMDZR");
        MapGenStructureIO.registerStructureComponent(CustomOceanMonumentPieces.EntryRoom.class, "OMEntry");
        MapGenStructureIO.registerStructureComponent(CustomOceanMonumentPieces.Penthouse.class, "OMPenthouse");
        MapGenStructureIO.registerStructureComponent(CustomOceanMonumentPieces.SimpleRoom.class, "OMSimple");
        MapGenStructureIO.registerStructureComponent(CustomOceanMonumentPieces.SimpleTopRoom.class, "OMSimpleT");
    }

    public static class DoubleXRoom extends CustomOceanMonumentPieces.Piece
        {
            private static final String __OBFID = "CL_00001983";

            public DoubleXRoom() {}

            public DoubleXRoom(EnumFacing p_i45597_1_, CustomOceanMonumentPieces.RoomDefinition p_i45597_2_, Random p_i45597_3_)
            {
            ...
            {
                CustomOceanMonumentPieces.RoomDefinition roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.EAST.getIndex()];
                CustomOceanMonumentPieces.RoomDefinition roomdefinition1 = this.field_175830_k;
    ...
    public static class DoubleXYRoom extends CustomOceanMonumentPieces.Piece
        {
            private static final String __OBFID = "CL_00001982";

            public DoubleXYRoom() {}

            public DoubleXYRoom(EnumFacing p_i45596_1_, CustomOceanMonumentPieces.RoomDefinition p_i45596_2_, Random p_i45596_3_)
            {
            ...
            public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                CustomOceanMonumentPieces.RoomDefinition roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.EAST.getIndex()];
                CustomOceanMonumentPieces.RoomDefinition roomdefinition1 = this.field_175830_k;
                CustomOceanMonumentPieces.RoomDefinition roomdefinition2 = roomdefinition1.field_175965_b[EnumFacing.UP.getIndex()];
                CustomOceanMonumentPieces.RoomDefinition roomdefinition3 = roomdefinition.field_175965_b[EnumFacing.UP.getIndex()];
    ...
    public static class DoubleYRoom extends CustomOceanMonumentPieces.Piece
        {
            private static final String __OBFID = "CL_00001981";

            public DoubleYRoom() {}

            public DoubleYRoom(EnumFacing p_i45595_1_, CustomOceanMonumentPieces.RoomDefinition p_i45595_2_, Random p_i45595_3_)
            {
            ...
            public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                ...
                CustomOceanMonumentPieces.RoomDefinition roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.UP.getIndex()];
    ...
    public static class DoubleYZRoom extends CustomOceanMonumentPieces.Piece
        {
            private static final String __OBFID = "CL_00001980";

            public DoubleYZRoom() {}

            public DoubleYZRoom(EnumFacing p_i45594_1_, CustomOceanMonumentPieces.RoomDefinition p_i45594_2_, Random p_i45594_3_)
            {
            ...
            public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                CustomOceanMonumentPieces.RoomDefinition roomdefinition = this.field_175830_k.field_175965_b[EnumFacing.NORTH.getIndex()];
                CustomOceanMonumentPieces.RoomDefinition roomdefinition1 = this.field_175830_k;
                CustomOceanMonumentPieces.RoomDefinition roomdefinition2 = roomdefinition.field_175965_b[EnumFacing.UP.getIndex()];
                CustomOceanMonumentPieces.RoomDefinition roomdefinition3 = roomdefinition1.field_175965_b[EnumFacing.UP.getIndex()];
    ...
    public static class DoubleZRoom extends CustomOceanMonumentPieces.Piece
        {
            private static final String __OBFID = "CL_00001979";

            public DoubleZRoom() {}

            public DoubleZRoom(EnumFacing p_i45593_1_, CustomOceanMonumentPieces.RoomDefinition p_i45593_2_, Random p_i45593_3_)
            {
    ...
    public static class EntryRoom extends CustomOceanMonumentPieces.Piece
        {
            private static final String __OBFID = "CL_00001978";

            public EntryRoom() {}

            public EntryRoom(EnumFacing p_i45592_1_, CustomOceanMonumentPieces.RoomDefinition p_i45592_2_)
            {
    ...
    static class FitSimpleRoomHelper implements CustomOceanMonumentPieces.MonumentRoomFitHelper
        {
            private static final String __OBFID = "CL_00001987";

            private FitSimpleRoomHelper() {}

            public boolean func_175969_a(CustomOceanMonumentPieces.RoomDefinition p_175969_1_)
            {
                return true;
            }

            public CustomOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, CustomOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
            {
                p_175968_2_.field_175963_d = true;
                return new CustomOceanMonumentPieces.SimpleRoom(p_175968_1_, p_175968_2_, p_175968_3_);
            }

            FitSimpleRoomHelper(CustomOceanMonumentPieces.SwitchEnumFacing p_i45601_1_)
            {
                this();
            }
        }

    static class FitSimpleRoomTopHelper implements CustomOceanMonumentPieces.MonumentRoomFitHelper
        {
            ...
            {
                p_175968_2_.field_175963_d = true;
                return new CustomOceanMonumentPieces.SimpleTopRoom(p_175968_1_, p_175968_2_, p_175968_3_);
            }

            FitSimpleRoomTopHelper(CustomOceanMonumentPieces.SwitchEnumFacing p_i45600_1_)
            {
                this();
            }
        }

    public static class MonumentBuilding extends CustomOceanMonumentPieces.Piece
        {
            private CustomOceanMonumentPieces.RoomDefinition field_175845_o;
            private CustomOceanMonumentPieces.RoomDefinition field_175844_p;
            ...
            public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_)
            {
                ...
                switch (CustomOceanMonumentPieces.SwitchEnumFacing.field_175971_a[this.coordBaseMode.ordinal()])
                {
                    case 1:
                    case 2:
                ...
                this.field_175843_q.add(new CustomOceanMonumentPieces.EntryRoom(this.coordBaseMode, this.field_175845_o));
                this.field_175843_q.add(new CustomOceanMonumentPieces.MonumentCoreRoom(this.coordBaseMode, this.field_175844_p, p_i45599_1_));
                ArrayList arraylist = Lists.newArrayList();
                arraylist.add(new CustomOceanMonumentPieces.XYDoubleRoomFitHelper((CustomOceanMonumentPieces.SwitchEnumFacing)null));
                arraylist.add(new CustomOceanMonumentPieces.YZDoubleRoomFitHelper((CustomOceanMonumentPieces.SwitchEnumFacing)null));
                arraylist.add(new CustomOceanMonumentPieces.ZDoubleRoomFitHelper((CustomOceanMonumentPieces.SwitchEnumFacing)null));
                arraylist.add(new CustomOceanMonumentPieces.XDoubleRoomFitHelper((CustomOceanMonumentPieces.SwitchEnumFacing)null));
                arraylist.add(new CustomOceanMonumentPieces.YDoubleRoomFitHelper((CustomOceanMonumentPieces.SwitchEnumFacing)null));
                arraylist.add(new CustomOceanMonumentPieces.FitSimpleRoomTopHelper((CustomOceanMonumentPieces.SwitchEnumFacing)null));
                arraylist.add(new CustomOceanMonumentPieces.FitSimpleRoomHelper((CustomOceanMonumentPieces.SwitchEnumFacing)null));
                Iterator iterator = list.iterator();

                while (iterator.hasNext())
                {
                    CustomOceanMonumentPieces.RoomDefinition roomdefinition = (CustomOceanMonumentPieces.RoomDefinition)iterator.next();
                    ...
                    if (!roomdefinition.field_175963_d && !roomdefinition.func_175961_b())
                    {
                        ...
                        {
                            CustomOceanMonumentPieces.MonumentRoomFitHelper monumentroomfithelper = (CustomOceanMonumentPieces.MonumentRoomFitHelper)iterator1.next();
                ...
                {
                    CustomOceanMonumentPieces.Piece piece = (CustomOceanMonumentPieces.Piece)iterator2.next();
                ...
                this.field_175843_q.add(new CustomOceanMonumentPieces.WingRoom(this.coordBaseMode, structureboundingbox1, k++));
                this.field_175843_q.add(new CustomOceanMonumentPieces.WingRoom(this.coordBaseMode, structureboundingbox2, k++));
                this.field_175843_q.add(new CustomOceanMonumentPieces.Penthouse(this.coordBaseMode, structureboundingbox));
            }

            private List func_175836_a(Random p_175836_1_)
            {
                CustomOceanMonumentPieces.RoomDefinition[] aroomdefinition = new CustomOceanMonumentPieces.RoomDefinition[75];
                int i;
                int j;
                byte b0;
                int k;
                ...
                for (i = 0; i < 5; ++i)
                {
                    for (j = 0; j < 4; ++j)
                    {
                        ...
                        aroomdefinition[k] = new CustomOceanMonumentPieces.RoomDefinition(k);
                    }
                }
                ...
                CustomOceanMonumentPieces.RoomDefinition roomdefinition;
                CustomOceanMonumentPieces.RoomDefinition roomdefinition1;
                CustomOceanMonumentPieces.RoomDefinition roomdefinition2;
                aroomdefinition[field_175831_h].func_175957_a(EnumFacing.UP, roomdefinition = new CustomOceanMonumentPieces.RoomDefinition(1003));
                aroomdefinition[field_175832_i].func_175957_a(EnumFacing.SOUTH, roomdefinition1 = new CustomOceanMonumentPieces.RoomDefinition(1001));
                aroomdefinition[field_175829_j].func_175957_a(EnumFacing.SOUTH, roomdefinition2 = new CustomOceanMonumentPieces.RoomDefinition(1002));
                ...
                ArrayList arraylist = Lists.newArrayList();
                CustomOceanMonumentPieces.RoomDefinition[] aroomdefinition1 = aroomdefinition;
                l = aroomdefinition.length;

                for (i1 = 0; i1 < l; ++i1)
                {
                    CustomOceanMonumentPieces.RoomDefinition roomdefinition4 = aroomdefinition1[i1];
                ...
                while (iterator.hasNext())
                {
                    CustomOceanMonumentPieces.RoomDefinition roomdefinition3 = (CustomOceanMonumentPieces.RoomDefinition)iterator.next();
                    int l2 = 0;
                    j1 = 0;
            ...
            public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
            {
                ...
                while (iterator.hasNext())
                {
                    CustomOceanMonumentPieces.Piece piece = (CustomOceanMonumentPieces.Piece)iterator.next();
    ...
    public static class MonumentCoreRoom extends CustomOceanMonumentPieces.Piece
        {
            private static final String __OBFID = "CL_00001984";

            public MonumentCoreRoom() {}

            public MonumentCoreRoom(EnumFacing p_i45598_1_, CustomOceanMonumentPieces.RoomDefinition p_i45598_2_, Random p_i45598_3_)
            {
    ...
    {
        boolean func_175969_a(CustomOceanMonumentPieces.RoomDefinition p_175969_1_);

        CustomOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, CustomOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_);
    }

    public static class Penthouse extends CustomOceanMonumentPieces.Piece
        {
    ...
    public abstract static class Piece extends StructureComponent
        {
            ...
            protected static final IBlockState field_175822_f = Blocks.air.getDefaultState();
            ...
            protected CustomOceanMonumentPieces.RoomDefinition field_175830_k;
            ...
            protected Piece(int p_i45590_1_, EnumFacing p_i45590_2_, CustomOceanMonumentPieces.RoomDefinition p_i45590_3_, int p_i45590_4_, int p_i45590_5_, int p_i45590_6_)
            {
                super(p_i45590_1_);
                ...
                switch (CustomOceanMonumentPieces.SwitchEnumFacing.field_175971_a[p_i45590_2_.ordinal()])
                {
                    case 1:
    ...
    static class RoomDefinition
        {
            int field_175967_a;
            CustomOceanMonumentPieces.RoomDefinition[] field_175965_b = new CustomOceanMonumentPieces.RoomDefinition[6];
            ...
            public void func_175957_a(EnumFacing p_175957_1_, CustomOceanMonumentPieces.RoomDefinition p_175957_2_)
            {
    ...
    public static class SimpleRoom extends CustomOceanMonumentPieces.Piece
        {
            ...
            public SimpleRoom(EnumFacing p_i45587_1_, CustomOceanMonumentPieces.RoomDefinition p_i45587_2_, Random p_i45587_3_)
            {
    ...
    public static class SimpleTopRoom extends CustomOceanMonumentPieces.Piece
        {
            private static final String __OBFID = "CL_00001974";

            public SimpleTopRoom() {}

            public SimpleTopRoom(EnumFacing p_i45586_1_, CustomOceanMonumentPieces.RoomDefinition p_i45586_2_, Random p_i45586_3_)
            {
    ...
    public static class WingRoom extends CustomOceanMonumentPieces.Piece
        {
    ...
    static class XDoubleRoomFitHelper implements CustomOceanMonumentPieces.MonumentRoomFitHelper
        {
            ...
            public CustomOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, CustomOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
            {
                ...
                return new CustomOceanMonumentPieces.DoubleXRoom(p_175968_1_, p_175968_2_, p_175968_3_);
            }

            XDoubleRoomFitHelper(CustomOceanMonumentPieces.SwitchEnumFacing p_i45606_1_)
            {
                this();
            }
        }

    static class XYDoubleRoomFitHelper implements CustomOceanMonumentPieces.MonumentRoomFitHelper
        {
            ...
            public boolean func_175969_a(CustomOceanMonumentPieces.RoomDefinition p_175969_1_)
            {
                ...
                {
                    CustomOceanMonumentPieces.RoomDefinition roomdefinition = p_175969_1_.field_175965_b[EnumFacing.EAST.getIndex()];
            ...
            public CustomOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, CustomOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
            {
                ...
                return new CustomOceanMonumentPieces.DoubleXYRoom(p_175968_1_, p_175968_2_, p_175968_3_);
            }

            XYDoubleRoomFitHelper(CustomOceanMonumentPieces.SwitchEnumFacing p_i45605_1_)
            {
                this();
            }
        }

    static class YDoubleRoomFitHelper implements CustomOceanMonumentPieces.MonumentRoomFitHelper
        {
            ...
            public CustomOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, CustomOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
            {
                p_175968_2_.field_175963_d = true;
                p_175968_2_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d = true;
                return new CustomOceanMonumentPieces.DoubleYRoom(p_175968_1_, p_175968_2_, p_175968_3_);
            }

            YDoubleRoomFitHelper(CustomOceanMonumentPieces.SwitchEnumFacing p_i45604_1_)
            {
                this();
            }
        }

    static class YZDoubleRoomFitHelper implements CustomOceanMonumentPieces.MonumentRoomFitHelper
        {
            ...
            public boolean func_175969_a(CustomOceanMonumentPieces.RoomDefinition p_175969_1_)
            {
                ...
                {
                    CustomOceanMonumentPieces.RoomDefinition roomdefinition = p_175969_1_.field_175965_b[EnumFacing.NORTH.getIndex()];
                    return roomdefinition.field_175966_c[EnumFacing.UP.getIndex()] && !roomdefinition.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d;
                }
                else
                {
            ...
            public CustomOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, CustomOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
            {
                ...
                return new CustomOceanMonumentPieces.DoubleYZRoom(p_175968_1_, p_175968_2_, p_175968_3_);
            }

            YZDoubleRoomFitHelper(CustomOceanMonumentPieces.SwitchEnumFacing p_i45603_1_)
            {
                this();
            }
        }

    static class ZDoubleRoomFitHelper implements CustomOceanMonumentPieces.MonumentRoomFitHelper
        {
            ...
            public CustomOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, CustomOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
            {
                CustomOceanMonumentPieces.RoomDefinition roomdefinition = p_175968_2_;
                ...
                return new CustomOceanMonumentPieces.DoubleZRoom(p_175968_1_, roomdefinition, p_175968_3_);
            }

            ZDoubleRoomFitHelper(CustomOceanMonumentPieces.SwitchEnumFacing p_i45602_1_)
            {
                this();
            }
        }
