...
//import net.minecraft.world.gen.structure.CustomOceanMonumentPieces;
...
public class CustomOceanMonument extends Village
{
    private int field_175800_f;
    private int field_175801_g;
	private World worldObj;
	private Random rand;
    public static final List field_175802_d = Arrays.asList(new BiomeGenBase[] {BiomeGenBase.desert, BiomeGenBase.plains});
    private static final List field_175803_h = Lists.newArrayList();
    private static final String __OBFID = "CL_00001996";

    public CustomOceanMonument()
    {
        this.field_175800_f = 32;
        this.field_175801_g = 5;
    }

    public CustomOceanMonument(Map p_i45608_1_)
    {
        this();
    ...
    {
        return new CustomOceanMonument.StartMonument(this.worldObj, this.rand, p_75049_1_, p_75049_2_);
    }
    ...
    public static class StartMonument extends StructureStart
        {
            ...
            private void func_175789_b(World worldIn, Random p_175789_2_, int p_175789_3_, int p_175789_4_)
            {
                ...
                this.components.add(new CustomOceanMonumentPieces.MonumentBuilding(p_175789_2_, k1, l1, enumfacing));
