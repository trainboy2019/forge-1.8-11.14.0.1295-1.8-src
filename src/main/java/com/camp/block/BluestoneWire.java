...
public class BluestoneWire extends BlockRedstoneWire
{
	public static final String name = "BluestoneWire";
    public static final PropertyEnum NORTH = PropertyEnum.create("north", BluestoneWire.EnumAttachPosition.class);
    public static final PropertyEnum EAST = PropertyEnum.create("east", BluestoneWire.EnumAttachPosition.class);
    public static final PropertyEnum SOUTH = PropertyEnum.create("south", BluestoneWire.EnumAttachPosition.class);
    public static final PropertyEnum WEST = PropertyEnum.create("west", BluestoneWire.EnumAttachPosition.class);
    public static final PropertyInteger POWER = PropertyInteger.create("power", 0, 100);
    private boolean canProvidePower = true;
    private final Set blocksNeedingUpdate = Sets.newHashSet();
    private static final String __OBFID = "CL_00000295";

    public BluestoneWire()
    {
    	
        super(Material.circuits);
        this.setDefaultState(this.blockState.getBaseState().withProperty(NORTH, BluestoneWire.EnumAttachPosition.NONE).withProperty(EAST, BluestoneWire.EnumAttachPosition.NONE).withProperty(SOUTH, BluestoneWire.EnumAttachPosition.NONE).withProperty(WEST, BluestoneWire.EnumAttachPosition.NONE).withProperty(POWER, Integer.valueOf(0)));
    ...
    private BluestoneWire.EnumAttachPosition getAttachPosition(IBlockAccess worldIn, BlockPos pos, EnumFacing direction)
    {
        ...
        if (!canRestoneConnect(worldIn, blockpos1, direction) && (block.isSolidFullCube() || !canRestoneConnect(worldIn, blockpos1.down(), null)))
        {
            ...
            return !block1.isSolidFullCube() && block.isSolidFullCube() && canRestoneConnect(worldIn, blockpos1.up(), null) ? BluestoneWire.EnumAttachPosition.UP : BluestoneWire.EnumAttachPosition.NONE;
        }
        else
        {
            return BluestoneWire.EnumAttachPosition.SIDE;
        }
    }
