...
public class BluestoneRepeater extends BlockRedstoneDiode
{
    public static final PropertyBool LOCKED = PropertyBool.create("locked");
    public static final PropertyInteger DELAY = PropertyInteger.create("delay", 0, 0);
    private static final String __OBFID = "CL_00000301";

    protected BluestoneRepeater(boolean powered)
    {
        super(powered);
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return this.getDefaultState().withProperty(FACING, enumfacing).withProperty(DELAY, integer).withProperty(LOCKED, obool);
    }
